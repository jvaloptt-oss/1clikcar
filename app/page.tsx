      ...
      <section className="py-32 px-6">
        <div className="max-w-6xl mx-auto bg-white rounded-3xl shadow-2xl p-16 text-center">
          <h1 className="text-5xl font-extrabold mb-6">
            Compramos tu coche
            <br />
            <span className="text-blue-700">con valoración profesional</span>
          </h1>

          <p className="text-gray-600 text-lg mb-10">
            Analizamos tu vehículo con detalle y te damos una oferta real
            sin compromiso.
          </p>
    ...
    <div className="max-w-4xl mx-auto bg-white rounded-3xl shadow-2xl p-16">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="md:col-span-2 text-sm text-gray-500">
          📸 Las fotos del coche se solicitarán por WhatsApp tras enviar el formulario.
        </div>
